...
Level-view′ D (ne′ _ _ D′ neK K≡K) =
  ⊥-elim (Level≢ne (ne⁻ neK) (whrDet* (D , Levelₙ) (D′ , ne! neK)))
...
U-view′ A⇒U (ne′ _ _ D neK K≡K) =
  ⊥-elim (U≢ne (ne⁻ neK) (whrDet* (A⇒U , Uₙ) (D , ne! neK)))
...
Lift-view′ A⇒Lift (ne′ _ _ D neK K≡K) =
  ⊥-elim (Lift≢ne (ne⁻ neK) (whrDet* (A⇒Lift , Liftₙ) (D , ne! neK)))
...
ℕ-view′ D (ne′ _ _ D′ neK K≡K) =
  ⊥-elim (ℕ≢ne (ne⁻ neK) (whrDet* (D , ℕₙ) (D′ , ne! neK)))
...
Empty-view′ D (ne′ _ _ D′ neK K≡K) =
  ⊥-elim (Empty≢ne (ne⁻ neK) (whrDet* (D , Emptyₙ) (D′ , ne! neK)))
...
Unit-view′ D (ne′ _ _ D′ neK K≡K) =
  ⊥-elim (Unit≢ne (ne⁻ neK) (whrDet* (D , Unitₙ) (D′ , ne! neK)))
...
B-view′ {W} D (ne′ _ _ D′ neK K≡K) =
  ⊥-elim (B≢ne W (ne⁻ neK) (whrDet* (D , ⟦ W ⟧ₙ) (D′ , ne! neK)))
...
Id-view′ ⇒*Id (ne′ _ _ ⇒*ne n _) =
  ⊥-elim (Id≢ne (ne⁻ n) (whrDet* (⇒*Id , Idₙ) (⇒*ne , ne! n)))
...
goodCases (Uᵣ _) (ne′ _ _ D' neK K≡K) (U₌ _ D _) =
  ⊥-elim (U≢ne (ne⁻ neK) (whrDet* (D , Uₙ) (D' , ne! neK)))
...
... | ()
goodCases (Liftᵣ _) (ne′ _ _ D' neK K≡K) (Lift₌ D _ _) =
  ⊥-elim (Lift≢ne (ne⁻ neK) (whrDet* (D , Liftₙ) (D' , ne! neK)))
...
goodCases (ℕᵣ D) (ne′ _ _ D₁ neK K≡K) A≡B =
  ⊥-elim (ℕ≢ne (ne⁻ neK) (whrDet* (A≡B , ℕₙ) (D₁ , ne! neK)))
...
goodCases (Emptyᵣ D) (ne′ _ _ D₁ neK K≡K) A≡B =
  ⊥-elim (Empty≢ne (ne⁻ neK) (whrDet* (A≡B , Emptyₙ) (D₁ , ne! neK)))
...
... | ()
goodCases (Unitᵣ _) (ne′ _ _ D' neK K≡K) (Unit₌ D) =
  ⊥-elim (Unit≢ne (ne⁻ neK) (whrDet* (D , Unitₙ) (D' , ne! neK)))
...
goodCases (ne _) (Levelᵣ D') (ne₌ _ M D′ neM K≡M) =
  ⊥-elim (Level≢ne (ne⁻ neM) (whrDet* (D' , Levelₙ) (D′ , ne! neM)))
goodCases (ne _) (Uᵣ′ _ _ _ D') (ne₌ _ M D′ neM K≡M) =
  ⊥-elim (U≢ne (ne⁻ neM) (whrDet* (D' , Uₙ) (D′ , ne! neM)))
goodCases (ne _) (Liftᵣ′ D' _ _) (ne₌ _ M D′ neM K≡M) =
  ⊥-elim (Lift≢ne (ne⁻ neM) (whrDet* (D' , Liftₙ) (D′ , ne! neM)))
goodCases (ne _) (ℕᵣ D₁) (ne₌ _ M D′ neM K≡M) =
  ⊥-elim (ℕ≢ne (ne⁻ neM) (whrDet* (D₁ , ℕₙ) (D′ , ne! neM)))
goodCases (ne _) (Emptyᵣ D₁) (ne₌ _ M D′ neM K≡M) =
  ⊥-elim (Empty≢ne (ne⁻ neM) (whrDet* (D₁ , Emptyₙ) (D′ , ne! neM)))
goodCases (ne _) (Unitᵣ′ D₁ _) (ne₌ _ M D′ neM K≡M) =
  ⊥-elim (Unit≢ne (ne⁻ neM) (whrDet* (D₁ , Unitₙ) (D′ , ne! neM)))
goodCases (ne _) (Bᵣ′ W _ _ D₁ _ _ _ _ _) (ne₌ _ _ D₂ neM _) =
  ⊥-elim (B≢ne W (ne⁻ neM) (whrDet* (D₁ , ⟦ W ⟧ₙ) (D₂ , ne! neM)))
...
combine (Levelᵥ LevelA LevelB) (ne (ne _ _ D neK K≡K) neB) =
  ⊥-elim (Level≢ne (ne⁻ neK) (whrDet* (LevelB , Levelₙ) (D , ne! neK)))
...
combine (Uᵥ UA (Uᵣ _ _ _ ⇒*U)) (ne (ne _ _ D neK K≡K) neB) =
  ⊥-elim (U≢ne (ne⁻ neK) (whrDet* (⇒*U , Uₙ) (D , ne! neK)))
...
... | ()
combine (Liftᵥ LiftA (Liftᵣ D' _ _)) (ne (ne _ _ D neK K≡K) neB) =
  ⊥-elim (Lift≢ne (ne⁻ neK) (whrDet* (D' , Liftₙ) (D , ne! neK)))
...
combine (ℕᵥ ℕA ℕB) (ne (ne _ _ D neK K≡K) neB) =
  ⊥-elim (ℕ≢ne (ne⁻ neK) (whrDet* (ℕB , ℕₙ) (D , ne! neK)))
...
combine (Emptyᵥ EmptyA EmptyB) (ne (ne _ _ D neK K≡K) neB) =
  ⊥-elim (Empty≢ne (ne⁻ neK) (whrDet* (EmptyB , Emptyₙ) (D , ne! neK)))
combine
...
... | ()
combine (Unitᵥ UnitA (Unitᵣ UnitB _)) (ne (ne _ _ D neK K≡K) neB) =
  ⊥-elim (Unit≢ne (ne⁻ neK) (whrDet* (UnitB , Unitₙ) (D , ne! neK)))
...
combine (ne neA (ne _ _ D neK K≡K)) (Levelᵥ LevelA LevelB) =
  ⊥-elim (Level≢ne (ne⁻ neK) (whrDet* (LevelA , Levelₙ) (D , ne! neK)))
combine (ne neA (ne _ _ D neK K≡K)) (Uᵥ (Uᵣ _ _ _ ⇒*U) UB) =
  ⊥-elim (U≢ne (ne⁻ neK) (whrDet* (⇒*U , Uₙ) (D , ne! neK)))
combine (ne neA (ne _ _ D neK K≡K)) (Liftᵥ (Liftᵣ ⇒*Lift _ _) LiftB) =
  ⊥-elim (Lift≢ne (ne⁻ neK) (whrDet* (⇒*Lift , Liftₙ) (D , ne! neK)))
combine (ne neA (ne _ _ D neK K≡K)) (ℕᵥ ℕA ℕB) =
  ⊥-elim (ℕ≢ne (ne⁻ neK) (whrDet* (ℕA , ℕₙ) (D , ne! neK)))
combine (ne neA (ne _ _ D neK K≡K)) (Emptyᵥ EmptyA EmptyB) =
  ⊥-elim (Empty≢ne (ne⁻ neK) (whrDet* (EmptyA , Emptyₙ) (D , ne! neK)))
combine (ne neA (ne _ _ D neK K≡K)) (Unitᵥ (Unitᵣ UnA _) UnB) =
  ⊥-elim (Unit≢ne (ne⁻ neK) (whrDet* (UnA , Unitₙ) (D , ne! neK)))
