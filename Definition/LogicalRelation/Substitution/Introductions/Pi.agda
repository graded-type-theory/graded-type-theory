...
W-congᵛ {Γ = Γ} {F} {G} {H} {E} {l} (BΠ p q) [Γ] [F] [G] [H] [E] [F≡H] [G≡E] {σ = σ} ⊢Δ [σ] =
...
W-congᵛ {Γ = Γ} {F} {G} {H} {E} {l} (BΣ q m) [Γ] [F] [G] [H] [E] [F≡H] [G≡E] {σ = σ} ⊢Δ [σ] =
...
Σ-congᵛ : ∀ {Γ : Con Term n} {F G H E l q m} → _
Σ-congᵛ {Γ = Γ} {F} {G} {H} {E} {l} {q} {m} = W-congᵛ {Γ = Γ} {F} {G} {H} {E} {l} (BΣ q m)

Σᵗᵛ : ∀ {Γ : Con Term n} {F G q m} → _
Σᵗᵛ {Γ = Γ} {F} {G} {q} {m} = Wᵗᵛ {Γ = Γ} {F} {G} (BΣ q m)

Σ-congᵗᵛ : ∀ {Γ : Con Term n} {F G H E q m} → _
Σ-congᵗᵛ {Γ = Γ} {F} {G} {H} {E} {q} {m} = W-congᵗᵛ {Γ = Γ} {F} {G} {H} {E} (BΣ q m)

××ᵛ : ∀ {Γ : Con Term n} {F G l q m} → _
××ᵛ {Γ = Γ} {F} {G} {l} {q} {m} = ndᵛ {Γ = Γ} {F} {G} {l} (BΣ q m)

××-congᵛ : ∀ {Γ : Con Term n} {F F′ G G′ l q m} → _
××-congᵛ {Γ = Γ} {F} {F′} {G} {G′} {l} {q} {m} = nd-congᵛ {Γ = Γ} {F} {F′} {G} {G′} {l} (BΣ q m)
