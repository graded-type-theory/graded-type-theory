...
mutual
  ...
  transConv↓Term A≡B (Unit-ins {s = Σₚ} x) (η-unit x₁ x₂ x₃ x₄) =
  ...
  transConv↓Term A≡B (Unit-ins x) (Σᵣ-ins x₁ x₂ x₃) = ⊥-elim (WF.Unit≢Σⱼ A≡B)
  ...
  transConv↓Term A≡B (Unit-ins {s = Σᵣ} x) (η-unit x₁ x₂ x₃ x₄) = ⊥-elim (WF.Unitʷ≢Unitˢ A≡B)
