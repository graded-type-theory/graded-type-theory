...
-- using greatest lower bounds in the usage rule for natrec.
------------------------------------------------------------------------
...
module Definition.Typed.Properties.Admissible.Bool.Greatest-lower-bound
  {a} {M : Set a}
  {𝕄 : Modality M}
  (R : Type-restrictions 𝕄)
  (open Type-restrictions R)
  (open Modality 𝕄)
  (open Definition.Untyped.Bool.Greatest-lower-bound 𝕄)
...
-- Export typing rules from Definition.Typed.Properties.Admissible.Bool
-- except those related to boolrec.

open B public hiding
  (boolrec-cong; ⊢boolrec; boolrec-true-⇒; boolrec-true-≡;
  boolrec-false-⇒; boolrec-false-≡)
