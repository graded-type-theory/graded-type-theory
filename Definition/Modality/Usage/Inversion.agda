...
record InvUsageNatrec {m} (γ : Conₘ m) (p r : M)
                      (z : Term m) (s : Term (1+ (1+ m))) (n : Term m) : Set where
...
inv-usage-natrec (natrecₘ δ▸z δ▸s η▸n r≤0) = invUsageNatrec δ▸z δ▸s η▸n r≤0 ≤ᶜ-refl
inv-usage-natrec (sub γ▸natrec γ≤γ′) with inv-usage-natrec γ▸natrec
... | invUsageNatrec δ▸z δ▸s η▸n r≤0 γ′≤γ″ = invUsageNatrec δ▸z δ▸s η▸n r≤0 (≤ᶜ-trans γ≤γ′ γ′≤γ″)
