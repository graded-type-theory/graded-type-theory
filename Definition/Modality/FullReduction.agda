...
mutual
  ...
  fullRedNe (snd-cong p~p) γ▸ =
    ...
    in  snd _ p′
      ...
      , snd-cong ⊢F ⊢G p≡p′
      , sub (sndₘ δ▸′) γ≤δ
  fullRedNe (natrec-cong {p = p} {r = r} C z s n) γ▸t =
  ...
  fullRedNe (Emptyrec-cong C n) γ▸t =
