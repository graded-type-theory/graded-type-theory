...
module _
  ...
  open Graded.Erasure.LogicalRelation.Hidden (assumptions ⊢Δ s)
...
module Fundamental
  ...
  private opaque
    ...
    fundamental′ (conv ⊢t A≡B) γ▸t <n =
      conv-▸⊩ʳ∷ (F.fundamental-⊩ᵛ≡ A≡B .proj₂) (fundamental′ ⊢t γ▸t <n)
