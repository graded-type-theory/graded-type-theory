...
open import Graded.Erasure.LogicalRelation.Fundamental.Application 𝕄 TR ⊢Δ 𝟘-well-behaved
open import Graded.Erasure.LogicalRelation.Fundamental.Empty 𝕄 TR ⊢Δ is-𝟘? consistent
open import Graded.Erasure.LogicalRelation.Fundamental.Lambda 𝕄 TR ⊢Δ is-𝟘? 𝟙≉𝟘
open import Graded.Erasure.LogicalRelation.Fundamental.Nat 𝕄 TR ⊢Δ is-𝟘?
open import Graded.Erasure.LogicalRelation.Fundamental.Natrec 𝕄 TR ⊢Δ 𝟘-well-behaved
open import Graded.Erasure.LogicalRelation.Fundamental.Prodrec 𝕄 TR ⊢Δ 𝟘-well-behaved
open import Graded.Erasure.LogicalRelation.Fundamental.Product 𝕄 TR UR ⊢Δ 𝟘-well-behaved
open import Graded.Erasure.LogicalRelation.Fundamental.Unit 𝕄 TR ⊢Δ is-𝟘?
open import Graded.Erasure.LogicalRelation.Conversion 𝕄 TR ⊢Δ is-𝟘?
