        ...
        (ΠΣₘ (▸Erased (level zeroᵘₘ) (B.▸OK ▸t)) $
         sub
           ...
           (begin
              ...
              (⌜ 𝟘ᵐ ⌝ · p) ·ᶜ (𝟘ᶜ ∙ 𝟙 ∙ 𝟙)                       ∎))
        (begin
           wkConₘ (stepn id k) γ₁ ∙ ⌜ 𝟘ᵐ ⌝ · (Boolᵍ + p)    ≈⟨ ≈ᶜ-refl ∙ ·-congˡ (+-identityˡ _) ⟩

           wkConₘ (stepn id k) γ₁ ∙ ⌜ 𝟘ᵐ ⌝ · p              ≈˘⟨ +ᶜ-identityˡ _ ⟩

           𝟘ᶜ +ᶜ (wkConₘ (stepn id k) γ₁ ∙ ⌜ 𝟘ᵐ ⌝ · p)      ≈˘⟨ +ᶜ-congʳ (·ᶜ-zeroʳ _) ⟩

           𝟙 ·ᶜ 𝟘ᶜ +ᶜ (wkConₘ (stepn id k) γ₁ ∙ ⌜ 𝟘ᵐ ⌝ · p) ∎)
