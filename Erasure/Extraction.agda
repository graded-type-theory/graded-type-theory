...
erase (U.prod _ 𝟘 _ u) = T.prod undefined (erase u)
erase (U.prod _ ω t u) = T.prod (erase t) (erase u)
erase (U.fst _ t) = T.fst (erase t)
erase (U.snd _ t) = T.snd (erase t)
erase (U.prodrec 𝟘 _ _ _ u) = erase u T.[ undefined , undefined ]
erase (U.prodrec ω _ _ t u) = T.prodrec (erase t) (erase u)
erase ℕ = undefined
erase U.zero = T.zero
