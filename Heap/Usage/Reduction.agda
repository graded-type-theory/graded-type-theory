...
opaque
  ...
  ▸-⇒ᵥ {γ} {δ} {η} (▸H , ▸t , ▸S , m≤ , γ≤) (unitrec-ηₕ {p} {E} {S} η-ok) =
    ...
    lemma {δ₂} 𝟘ᵐ m≤ δ≤ ok = begin
      γ                      ≤⟨ γ≤ ⟩
      ∣ S ∣ ·ᶜ wkᶜ E δ +ᶜ η  ≈⟨ +ᶜ-congʳ (·ᶜ-congʳ (𝟘ᵐ≤ᵐp→p≡𝟘 m≤)) ⟩
      𝟘 ·ᶜ wkᶜ E δ +ᶜ η      ≈⟨ +ᶜ-congʳ (·ᶜ-zeroˡ _) ⟩
      𝟘ᶜ +ᶜ η                ≈˘⟨ +ᶜ-congʳ (·ᶜ-zeroˡ _) ⟩
      𝟘 ·ᶜ wkᶜ E δ₂ +ᶜ η     ≈˘⟨ +ᶜ-congʳ (·ᶜ-congʳ (𝟘ᵐ≤ᵐp→p≡𝟘 m≤)) ⟩
      ∣ S ∣ ·ᶜ wkᶜ E δ₂ +ᶜ η ∎
  ...
  ▸-⇒ᵥ {γ} {δ} (▸H , ▸t , ▸S , m≤ , γ≤) (rflₕⱼ {E} {p} {q} {E′} {S}) =
    case ▸S of λ {
      (_∙_ {γ = η} (Jₑ {γ = δ′} ▸u , m′≤) ▸S) →
    _ , _ , _ , _ , ▸H , ▸u , ▸S , m′≤  , (begin
      γ                                                            ≤⟨ γ≤ ⟩
      (∣ S ∣ · ∣∣ᵉ-J em p q) ·ᶜ wkᶜ E δ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E′ δ′  ≤⟨ +ᶜ-monotoneˡ (·ᶜ-monotoneʳ (wk-≤ᶜ E (inv-usage-rfl ▸t))) ⟩
      (∣ S ∣ · ∣∣ᵉ-J em p q) ·ᶜ wkᶜ E 𝟘ᶜ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E′ δ′ ≡⟨ cong (λ x → (_ · _) ·ᶜ x +ᶜ _) (wk-𝟘ᶜ E) ⟩
      (∣ S ∣ · ∣∣ᵉ-J em p q) ·ᶜ 𝟘ᶜ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E′ δ′       ≈⟨ +ᶜ-congʳ (·ᶜ-zeroʳ _) ⟩
      𝟘ᶜ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E′ δ′                                 ≈⟨ +ᶜ-identityˡ _ ⟩
      η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E′ δ′                                       ≈⟨ +ᶜ-comm _ _ ⟩
      ∣ S ∣ ·ᶜ wkᶜ E′ δ′ +ᶜ η                                       ∎ )}
    where
  ...
  ▸-⇒ᵥ {γ} {δ} (▸H , ▸t , ▸S , m≤ , γ≤) (rflₕₖ {E} {p} {E′} {S}) =
    case ▸S of λ {
      (_∙_ {γ = η} (Kₑ {γ = δ′} ▸u , m′≤) ▸S) →
    _ , _ , _ , _ , ▸H , ▸u , ▸S , m′≤ , (begin
      γ                                                           ≤⟨ γ≤ ⟩
      (∣ S ∣ · ∣∣ᵉ-K em p) ·ᶜ wkᶜ E δ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E′ δ′   ≤⟨ +ᶜ-monotoneˡ (·ᶜ-monotoneʳ (wk-≤ᶜ E (inv-usage-rfl ▸t))) ⟩
      (∣ S ∣ · ∣∣ᵉ-K em p) ·ᶜ wkᶜ E 𝟘ᶜ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E′ δ′  ≡⟨ cong (λ x → (_ · _) ·ᶜ x +ᶜ _) (wk-𝟘ᶜ E) ⟩
      (∣ S ∣ · ∣∣ᵉ-K em p) ·ᶜ 𝟘ᶜ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E′ δ′        ≈⟨ +ᶜ-congʳ (·ᶜ-zeroʳ _) ⟩
      𝟘ᶜ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E′ δ′                                ≈⟨ +ᶜ-identityˡ _ ⟩
      η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E′ δ′                                      ≈⟨ +ᶜ-comm _ _ ⟩
      ∣ S ∣ ·ᶜ wkᶜ E′ δ′ +ᶜ η                                      ∎ )}
    where
  ...
  ▸-⇒ᵥ {γ} {δ} (▸H , ▸t , ▸S , m≤ , γ≤) (rflₕₑ {E} {E′} {S}) =
    case ▸S of λ {
      (_∙_ {γ = η} ([]-congₑ ok , m′≤) ▸S) →
    _ , _ , _ , _ , ▸H , rflₘ , ▸S , m′≤ , (begin
      γ                                          ≤⟨ γ≤ ⟩
      (∣ S ∣ · 𝟘) ·ᶜ wkᶜ E δ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ 𝟘ᶜ ≈⟨ +ᶜ-cong (·ᶜ-congʳ (·-zeroʳ _)) (+ᶜ-congˡ (·ᶜ-zeroʳ _)) ⟩
      𝟘 ·ᶜ wkᶜ E δ +ᶜ η +ᶜ 𝟘ᶜ                    ≈⟨ +ᶜ-cong (·ᶜ-zeroˡ _) (+ᶜ-identityʳ _) ⟩
      𝟘ᶜ +ᶜ η                                    ≈˘⟨ +ᶜ-congʳ (·ᶜ-zeroʳ _) ⟩
      ∣ S ∣ ·ᶜ 𝟘ᶜ +ᶜ η                           ≡˘⟨ cong (λ x → _ ·ᶜ x +ᶜ _) (wk-𝟘ᶜ E′) ⟩
      ∣ S ∣ ·ᶜ wkᶜ E′ 𝟘ᶜ +ᶜ η ∎) }
    where
    open RPo ≤ᶜ-poset
...
opaque
  ...
  ▸-⇒ₙ {γ} {δ} {η} (▸H , ▸t , ▸S , m≤ , γ≤) (emptyrecₕ {p} {E} {S}) =
    ...
    _ , _ , _ , _ , ▸H , ▸t , (emptyrecₑ ok , m≤) ∙ ▸S
      , ≤ᵐ-· m≤ , (begin
        γ                                              ≤⟨ γ≤ ⟩
        ∣ S ∣ ·ᶜ wkᶜ E δ +ᶜ η                          ≤⟨ +ᶜ-monotoneˡ (·ᶜ-monotoneʳ (wk-≤ᶜ E δ≤)) ⟩
        ∣ S ∣ ·ᶜ wkᶜ E (p ·ᶜ δ′) +ᶜ η                  ≈⟨ +ᶜ-cong (·ᶜ-congˡ (wk-·ᶜ E)) (≈ᶜ-sym (+ᶜ-identityʳ η)) ⟩
        ∣ S ∣ ·ᶜ p ·ᶜ wkᶜ E δ′ +ᶜ η +ᶜ 𝟘ᶜ              ≈˘⟨ +ᶜ-cong (·ᶜ-assoc _ _ _) (+ᶜ-congˡ (·ᶜ-zeroʳ _)) ⟩
        (∣ S ∣ · p) ·ᶜ wkConₘ E δ′ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ 𝟘ᶜ ∎)}
    where
    open RPo ≤ᶜ-poset
  ...
  ▸-⇒ₙ (▸H , ▸t , ▸S , m≤ , γ≤) (Jₕ {H}) = ▸-⇒ₙ-J ▸H ▸S m≤ γ≤ (inv-usage-J ▸t)
    ...
    open RPo ≤ᶜ-poset
    ▸-⇒ₙ-J-𝟘ᵐ : ∀ {γ₁ γ₂ ok}
              → γ ▸ʰ H → η ▸ˢ S → ∣ S ∣ ≡ 𝟘 → γ ≤ᶜ ∣ S ∣ ·ᶜ wkᶜ E δ +ᶜ η
              → γ₁ ▸[ 𝟘ᵐ[ ok ] ] u → γ₂ ▸[ 𝟘ᵐ[ ok ] ] w
              → ∃₄ (_⨾_⨾_▸[_] ⟨ H , w , E , Jₑ p q A t B u v E ∙ S ⟩)
    ▸-⇒ₙ-J-𝟘ᵐ {γ} {η} {S} {E} {δ} {p} {q} {γ₁} {γ₂} ▸H ▸S ∣S∣≡𝟘 γ≤ ▸u ▸w =
      _ , _ , _ , _ , ▸H , ▸w
        , (Jₑ ▸u , (subst (_ ≤ᵐ_) (sym ∣S∣≡𝟘) 𝟘ᵐ≤ᵐ𝟘)) ∙ ▸S
        , subst (_ ≤ᵐ_) (sym (trans (·-congʳ ∣S∣≡𝟘) (·-zeroˡ _))) 𝟘ᵐ≤ᵐ𝟘
        , (begin
            γ                                                           ≤⟨ γ≤ ⟩
            ∣ S ∣ ·ᶜ wkConₘ E δ +ᶜ η                                    ≈⟨ +ᶜ-congʳ (·ᶜ-congʳ ∣S∣≡𝟘) ⟩
            𝟘 ·ᶜ wkConₘ E δ +ᶜ η                                        ≈⟨ +ᶜ-congʳ (·ᶜ-zeroˡ _) ⟩
            ...
            𝟘 ·ᶜ wkᶜ E γ₂ +ᶜ η +ᶜ 𝟘 ·ᶜ wkᶜ E γ₁                         ≈˘⟨ +ᶜ-cong (·ᶜ-congʳ (·-zeroˡ _)) (+ᶜ-congˡ (·ᶜ-congʳ ∣S∣≡𝟘)) ⟩
            (𝟘 · ∣∣ᵉ-J em p q) ·ᶜ wkᶜ E γ₂ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E γ₁     ≈˘⟨ +ᶜ-congʳ (·ᶜ-congʳ (·-congʳ ∣S∣≡𝟘)) ⟩
            (∣ S ∣ · ∣∣ᵉ-J em p q) ·ᶜ wkᶜ E γ₂ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E γ₁ ∎)

    ▸-⇒ₙ-J : γ ▸ʰ H → η ▸ˢ S → m ≤ᵐ ∣ S ∣ → γ ≤ᶜ ∣ S ∣ ·ᶜ wkᶜ E δ +ᶜ η → InvUsageJ δ m p q A t B u v w
           → ∃₄ (_⨾_⨾_▸[_] ⟨ H , w , E , Jₑ p q A t B u v E ∙ S ⟩)
    ▸-⇒ₙ-J {m = 𝟘ᵐ} ▸H ▸S m≤ γ≤ (invUsageJ {γ₄} {γ₆} e e′ _ _ _ ▸u _ ▸w δ≤) =
      ▸-⇒ₙ-J-𝟘ᵐ ▸H ▸S (𝟘ᵐ≤ᵐp→p≡𝟘 m≤) γ≤ ▸u ▸w
    ▸-⇒ₙ-J {γ} {η} {S} {m = 𝟙ᵐ} {E} {δ} ▸H ▸S m≤ γ≤ (invUsageJ {γ₂} {γ₃} {γ₄} {γ₅} {γ₆} e e′ _ _ _ ▸u _ ▸w δ≤) rewrite ∣∣ᵉ-J-ω e e′ =
    ...
    ▸-⇒ₙ-J {γ} {η} {S} {m = 𝟙ᵐ} {E} {δ} ▸H ▸S m≤ γ≤ (invUsageJ₀₁ {γ₃} {γ₄} {γ₆} e≡some refl refl _ _ _ ▸u _ ▸w δ≤) rewrite ∣∣ᵉ-J-some₀₀ e≡some =
      _ , _ , _ , _ , ▸H , ▸w , (Jₑ ▸u , m≤) ∙ ▸S
        , subst (𝟘ᵐ? ≤ᵐ_) (sym (·-zeroʳ  _)) 𝟘ᵐ?≤ᵐ𝟘
        , (begin
            γ                                                   ≤⟨ γ≤ ⟩
            ∣ S ∣ ·ᶜ wkConₘ E δ +ᶜ η                            ≤⟨ +ᶜ-monotoneˡ (·ᶜ-monotoneʳ (wk-≤ᶜ E δ≤)) ⟩
            ∣ S ∣ ·ᶜ wkConₘ E (ω ·ᶜ (γ₃ +ᶜ γ₄)) +ᶜ η             ≤⟨ +ᶜ-monotoneˡ (·ᶜ-monotoneʳ (wk-≤ᶜ E ω·ᶜ+ᶜ≤ω·ᶜʳ)) ⟩
            ∣ S ∣ ·ᶜ wkConₘ E (ω ·ᶜ γ₄) +ᶜ η                     ≤⟨ +ᶜ-monotoneˡ (·ᶜ-monotoneʳ (wk-≤ᶜ E (·ᶜ-monotoneˡ ω≤𝟙))) ⟩
            ∣ S ∣ ·ᶜ wkConₘ E (𝟙 ·ᶜ γ₄) +ᶜ η                     ≈⟨ +ᶜ-congʳ (·ᶜ-congˡ (wk-≈ᶜ E (·ᶜ-identityˡ _))) ⟩
            ∣ S ∣ ·ᶜ wkConₘ E γ₄ +ᶜ η                            ≈⟨ +ᶜ-comm _ _ ⟩
            η +ᶜ ∣ S ∣ ·ᶜ wkConₘ E γ₄                            ≈˘⟨ +ᶜ-identityˡ _ ⟩
            𝟘ᶜ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkConₘ E γ₄                      ≈˘⟨ +ᶜ-congʳ (·ᶜ-zeroˡ _) ⟩
            𝟘 ·ᶜ wkConₘ E γ₆ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkConₘ E γ₄        ≈˘⟨ +ᶜ-congʳ (·ᶜ-congʳ (·-zeroʳ _)) ⟩
            (∣ S ∣ · 𝟘) ·ᶜ wkConₘ E γ₆ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E γ₄ ∎)
    ▸-⇒ₙ-J {m = 𝟘ᵐ} ▸H ▸S m≤ γ≤ (invUsageJ₀₂ e≡all _ _ _ ▸u _ ▸w δ≤) =
      ▸-⇒ₙ-J-𝟘ᵐ ▸H ▸S (𝟘ᵐ≤ᵐp→p≡𝟘 m≤) γ≤ ▸u (▸-cong 𝟘ᵐ?≡𝟘ᵐ ▸w)
    ▸-⇒ₙ-J {γ} {η} {S} {m = 𝟙ᵐ} {E} {δ} {p} {q} ▸H ▸S m≤ γ≤ (invUsageJ₀₂ {γ₄} {γ₆} e≡all _ _ _ ▸u _ ▸w δ≤) rewrite ∣∣ᵉ-J-all {p = p} {q = q} e≡all =
      _ , _ , _ , _ , ▸H , ▸w , (Jₑ ▸u , m≤) ∙ ▸S
        , subst (𝟘ᵐ? ≤ᵐ_) (sym (·-zeroʳ  _)) 𝟘ᵐ?≤ᵐ𝟘
        , (begin
            γ                                                    ≤⟨ γ≤ ⟩
  ...
  ▸-⇒ₙ (▸H , ▸t , ▸S , m≤ , γ≤) (Kₕ {H}) = ▸-⇒ₙ-K ▸H ▸S m≤ γ≤ (inv-usage-K ▸t)
    ...
    ▸-⇒ₙ-K-𝟘ᵐ : ∀ {γ₁ γ₂ ok}
              → γ ▸ʰ H → η ▸ˢ S → ∣ S ∣ ≡ 𝟘 → γ ≤ᶜ ∣ S ∣ ·ᶜ wkᶜ E δ +ᶜ η
              → γ₁ ▸[ 𝟘ᵐ[ ok ] ] u → γ₂ ▸[ 𝟘ᵐ[ ok ] ] v
              → ∃₄ (_⨾_⨾_▸[_] ⟨ H , v , E , Kₑ p A t B u E ∙ S ⟩)
    ▸-⇒ₙ-K-𝟘ᵐ {γ} {η} {S} {E} {δ} {p} {γ₁} {γ₂} ▸H ▸S ∣S∣≡𝟘 γ≤ ▸u ▸v =
      _ , _ , _ , _ , ▸H , ▸v
        ...
        , (begin
            ...
            𝟘ᶜ +ᶜ η +ᶜ 𝟘ᶜ                                             ≈˘⟨ +ᶜ-cong (·ᶜ-zeroˡ _) (+ᶜ-congˡ (·ᶜ-zeroˡ _)) ⟩
            𝟘 ·ᶜ wkᶜ E γ₂ +ᶜ η +ᶜ 𝟘 ·ᶜ wkᶜ E γ₁                       ≈˘⟨ +ᶜ-cong (·ᶜ-congʳ (·-zeroˡ _)) (+ᶜ-congˡ (·ᶜ-congʳ ∣S∣≡𝟘)) ⟩
            (𝟘 · ∣∣ᵉ-K em p) ·ᶜ wkᶜ E γ₂ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E γ₁     ≈˘⟨ +ᶜ-congʳ (·ᶜ-congʳ (·-congʳ ∣S∣≡𝟘)) ⟩
            (∣ S ∣ · ∣∣ᵉ-K em p) ·ᶜ wkᶜ E γ₂ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E γ₁ ∎)
    ▸-⇒ₙ-K : γ ▸ʰ H → η ▸ˢ S → m ≤ᵐ ∣ S ∣ → γ ≤ᶜ ∣ S ∣ ·ᶜ wkᶜ E δ +ᶜ η → InvUsageK δ m p A t B u v
           → ∃₄ (_⨾_⨾_▸[_] ⟨ H , v , E , Kₑ p A t B u E ∙ S ⟩)
    ▸-⇒ₙ-K {m = 𝟘ᵐ} ▸H ▸S m≤ γ≤ (invUsageK _ _ _ _ _ ▸u ▸v _) =
      ▸-⇒ₙ-K-𝟘ᵐ ▸H ▸S (𝟘ᵐ≤ᵐp→p≡𝟘 m≤) γ≤ ▸u ▸v
    ▸-⇒ₙ-K {γ} {η} {S} {m = 𝟙ᵐ} {E} {δ} {p} ▸H ▸S m≤ γ≤ (invUsageK {γ₂} {γ₃} {γ₄} {γ₅} e e′ _ _ _ ▸u ▸v δ≤) rewrite ∣∣ᵉ-K-ω e e′ =
    ...
    ▸-⇒ₙ-K {γ} {η} {S} {m = 𝟙ᵐ} {E} {δ} {p} ▸H ▸S m≤ γ≤ (invUsageK₀₁ {γ₃} {γ₄} {γ₅} e≡some refl _ _ _ ▸u ▸v δ≤) rewrite ∣∣ᵉ-K-some₀ e≡some =
      _ , _ , _ , _ , ▸H , ▸v , (Kₑ ▸u , m≤) ∙ ▸S
        , subst (𝟘ᵐ? ≤ᵐ_) (sym (·-zeroʳ  _)) 𝟘ᵐ?≤ᵐ𝟘
        , (begin
            γ                                                    ≤⟨ γ≤ ⟩
            ∣ S ∣ ·ᶜ wkᶜ E δ +ᶜ η                                ≈⟨ +ᶜ-comm _ _ ⟩
            η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E δ                                ≤⟨ +ᶜ-monotoneʳ (·ᶜ-monotoneʳ (wk-≤ᶜ E δ≤)) ⟩
            η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E (ω ·ᶜ (γ₃ +ᶜ γ₄))                ≤⟨ +ᶜ-monotoneʳ (·ᶜ-monotoneʳ (wk-≤ᶜ E ω·ᶜ+ᶜ≤ω·ᶜʳ)) ⟩
            η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E (ω ·ᶜ γ₄)                        ≤⟨ +ᶜ-monotoneʳ (·ᶜ-monotoneʳ (wk-≤ᶜ E (·ᶜ-monotoneˡ ω≤𝟙))) ⟩
            η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E (𝟙 ·ᶜ γ₄)                        ≈⟨ +ᶜ-congˡ (·ᶜ-congˡ (wk-≈ᶜ E (·ᶜ-identityˡ _))) ⟩
            η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E γ₄                               ≈˘⟨ +ᶜ-identityˡ _ ⟩
            𝟘ᶜ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E γ₄                         ≈˘⟨ +ᶜ-congʳ (·ᶜ-zeroˡ _) ⟩
            𝟘 ·ᶜ wkConₘ E γ₅ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E γ₄           ≈˘⟨ +ᶜ-congʳ (·ᶜ-congʳ (·-zeroʳ _)) ⟩
            (∣ S ∣ · 𝟘) ·ᶜ wkConₘ E γ₅ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ wkᶜ E γ₄ ∎)
    ▸-⇒ₙ-K {m = 𝟘ᵐ} ▸H ▸S m≤ γ≤ (invUsageK₀₂ _ _ _ _ ▸u ▸v _) =
      ▸-⇒ₙ-K-𝟘ᵐ ▸H ▸S (𝟘ᵐ≤ᵐp→p≡𝟘 m≤) γ≤ ▸u (▸-cong 𝟘ᵐ?≡𝟘ᵐ ▸v)
    ▸-⇒ₙ-K {γ} {η} {S} {m = 𝟙ᵐ} {E} {δ} {p} ▸H ▸S m≤ γ≤ (invUsageK₀₂ {γ₄} {γ₅} e≡all _ _ _ ▸u ▸v δ≤) rewrite ∣∣ᵉ-K-all {p = p} e≡all =
      _ , _ , _ , _ , ▸H , ▸v , (Kₑ ▸u , m≤) ∙ ▸S
        , subst (𝟘ᵐ? ≤ᵐ_) (sym (·-zeroʳ  _)) 𝟘ᵐ?≤ᵐ𝟘
        , (begin
            γ                                                    ≤⟨ γ≤ ⟩
  ...
  ▸-⇒ₙ {γ} {δ} {η} (▸H , ▸t , ▸S , m≤ , γ≤) ([]-congₕ {E} {S}) =
    ...
    _ , _ , _ , _ , ▸H , ▸v , ([]-congₑ ok , m≤) ∙ ▸S
      ...
      , (begin
          γ                                           ≤⟨ γ≤ ⟩
          ∣ S ∣ ·ᶜ wkᶜ E δ +ᶜ η                       ≤⟨ +ᶜ-monotoneˡ (·ᶜ-monotoneʳ (wk-≤ᶜ E δ≤)) ⟩
          ∣ S ∣ ·ᶜ wkᶜ E 𝟘ᶜ +ᶜ η                      ≡⟨ cong (λ x → _ ·ᶜ x +ᶜ _) (wk-𝟘ᶜ E) ⟩
          ∣ S ∣ ·ᶜ 𝟘ᶜ +ᶜ η                            ≈⟨ +ᶜ-cong (·ᶜ-zeroʳ _) (≈ᶜ-sym (+ᶜ-identityʳ _)) ⟩
          𝟘ᶜ +ᶜ η +ᶜ 𝟘ᶜ                               ≈˘⟨ +ᶜ-cong (·ᶜ-zeroˡ _) (+ᶜ-congˡ (·ᶜ-zeroʳ _)) ⟩
          𝟘 ·ᶜ wkᶜ E γ₄ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ 𝟘ᶜ           ≈˘⟨ +ᶜ-congʳ (·ᶜ-congʳ (·-zeroʳ _)) ⟩
          (∣ S ∣ · 𝟘) ·ᶜ wkᶜ E γ₄ +ᶜ η +ᶜ ∣ S ∣ ·ᶜ 𝟘ᶜ ∎)
    where
    open RPo ≤ᶜ-poset
